...
# Do we want Address sanatizer builds ? (1=yes 0=no)
%define asan 0
...
%if %{asan}
CFLAGS="$RPM_OPT_FLAGS -fsanitize=address"; export CFLAGS
LDFLAGS="$LDFLAGS -fsanitize=address"; export LDFLAGS
%endif
...
- Patches from OpenSSH8.0 CentOS8
